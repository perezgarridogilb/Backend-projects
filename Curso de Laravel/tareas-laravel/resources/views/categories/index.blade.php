...
<div class="container w-25 border p-4 mt-4">
    <div class="row mx-auto">
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="name" class="form-label">Título de la categoria</label>
                <input type="text" name="name" class="form-control" placeholder="Ingresar categoria">
            </div>

            <div class="mb-3">
                <label for="color" class="form-label">Color de la categoria</label>
                <input type="color" name="color" class="form-control" placeholder="Ingresar categoria">
            </div>
