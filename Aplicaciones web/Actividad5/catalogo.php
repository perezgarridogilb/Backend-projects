...
<body>
    ...
    for ($i = 0; $i < count($estado); $i++) {
        echo "<td>" . $estado[$i] . "<br>$" . $precio[$i] . "<br>Vendedor: " . consesionario($link, $consesionario[$i]) . "<br>Cantidad disponible: " . $cantidad[$i] . "<br><br><a href='confirmarCompra.php?id=" . $id[$i] . "&nombre=" . $estado[$i] . "'>Comprar</a></td>";
    }
